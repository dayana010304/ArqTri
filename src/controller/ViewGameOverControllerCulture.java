 ...
 * @author Dell
 */
public class ViewGameOverControllerCulture  {
 ...
 @FXML
    ...
    private void initialize() {
        correct = ViewQuestionsCultureController.correct;
        wrong = ViewQuestionsCultureController.wrong;

        correcttext.setText("Respuestas Correctas : " + correct);
        wrongtext.setText("Respuestas Incorrectas : " + String.valueOf(ViewQuestionsCultureController.wrong));
