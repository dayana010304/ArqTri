 ...
 * @author Dell
 */
public class ViewGameOverControllerMusic  {
 ...
 @FXML
    ...
    private void initialize() {
        correct = ViewQuestionsMusicController.correct;
        wrong = ViewQuestionsMusicController.wrong;

        correcttext.setText("Respuestas Correctas : " + correct);
        wrongtext.setText("Respuestas Incorrectas : " + String.valueOf(ViewQuestionsMusicController.wrong));
